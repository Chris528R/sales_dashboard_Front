                ...
                <tr key={prod.id}>
                  ...
                  <td className="text-end">
                    <div className="btn-group btn-group-sm">
                      <button className="btn btn-outline-primary" title="Ver Detalles" onClick={() => onView(prod)}>👁️</button>
                      <button className="btn btn-outline-warning" title="Modificar" onClick={() => onEdit(prod)}>✏️</button>
                      <button
