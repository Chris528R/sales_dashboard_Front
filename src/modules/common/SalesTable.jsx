                  ...
                  <tr key={sale.id}>
                    ...
                    <td className="text-end">
                      <div className="btn-group btn-group-sm">
                        <button className="btn btn-outline-info" title="Ver Productos" onClick={() => onView('VIEW', 'SALE', sale)}>📄</button>
                        <button className="btn btn-outline-warning" title="Modificar" onClick={() => onEdit('EDIT', 'SALE', sale)}>✏️</button>
